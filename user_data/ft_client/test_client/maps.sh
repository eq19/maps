...
curl -s -X POST -H "Authorization: Bearer ${BEARER}" -H "Content-Type: application/json" https://us-central1-marketleader.cloudfunctions.net/function --data @${ARTIFACT} > $HYPEROPT_PARAM
cat $HYPEROPT_PARAM
